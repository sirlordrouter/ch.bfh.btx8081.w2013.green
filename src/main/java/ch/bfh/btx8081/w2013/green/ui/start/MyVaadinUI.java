 ...
 * The UI is the server side entry point for various client side features
 *
...
public class MyVaadinUI extends UI
{
   ...
   // private BasicTextEncryptor encryptor = new BasicTextEncryptor();
    ...
    /*
     * @param AuthenticationState = new State of the application to be set
     */
	...
	// toDo: delete because it's not used
