 ...
 *
 *<p>Provides the logic to get the Data for the different Settings and to
 * save the new settings in a persistent storage. </p>
 *
 * @author Johannes Gnaegi, gnaegj1@bfh.ch
 * @version 11-12-2013
 */
public class SettingsUserDataManager  {
